...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.services.wakapi = {
      ...
      after = [ "network.target" ] # WARN: IDK these services name are
        ++ lib.optional (cfg.settings.db.dialect == "mysql") "mysql.service"
        ++ lib.optional (cfg.settings.db.dialect == "postgres") "postgresql.service"
        ++ lib.optional (cfg.settings.db.dialect == "cockroach") "cockroach.service"
        ++ lib.optional (cfg.settings.db.dialect == "mssql") "mssql.service";
